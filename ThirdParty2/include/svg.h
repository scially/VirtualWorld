...
typedef struct svg_render_engine {
    /* hierarchy */
    svg_status_t (* begin_group) (void *closure,
    				  double opacity,
				  const char *id,
				  const char *klass);
    ...
    /* transform */
    svg_status_t (* set_viewport) (void *closure,
    ...
    /* text positioning */
    svg_status_t (* text_advance_x) (void *closure,
				     const char *utf8,
				     double *advance);
    ...
    svg_status_t (* render_circle) (void *closure,
    ...
    svg_status_t (*measure_position) (void *closure,
				      ...
				      double *ox,
				      double *oy);
    svg_status_t (*measure_font_size) (void *closure,
...
svg_status_t
svg_marker_render (const svg_marker_t *marker,
		   double stroke_width,
		   svg_render_engine_t *engine,
		   void *closure);
...
svg_status_t
svg_get_bgra_image (const char *uri,
		    unsigned char **data,
...
svg_status_t
svg_get_image_filename (const char *uri,
		    	char **filename,
			int *is_temp_copy);
...
svg_status_t
svg_decode_data_scheme_uri (const char *uri,
		     	    char **media_type,
